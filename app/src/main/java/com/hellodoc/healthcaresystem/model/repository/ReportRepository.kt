...
class ReportRepositoryImpl @Inject constructor(private val reportService: ReportService): ReportRepository {
     ...
     */
    override suspend fun getAllReports(): Result<List<ComplaintData>> {
        return try {
    ...
    override suspend fun getReportByUserId(userId: String): Result<List<ComplaintData>> {
        return try {
    ...
    override suspend fun sendAdminResponse(
        id: String,
        responseContent: String,
        responseTime: String
