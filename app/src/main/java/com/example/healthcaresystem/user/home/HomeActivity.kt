...
//            }
    ...
    fun HomeScreenPreview() {
        HealthCareSystemTheme {
            ...
            val sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context) // Tạo một SharedPreferences giả lập
            Index(sharedPreferences = sharedPreferences)
        }
    }
