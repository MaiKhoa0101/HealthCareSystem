...
public abstract class Hilt_Intro2 extends BaseActivity implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Intro2_GeneratedInjector) this.generatedComponent()).injectIntro2(UnsafeCasts.<Intro2>unsafeCast(this));
    }
  }
