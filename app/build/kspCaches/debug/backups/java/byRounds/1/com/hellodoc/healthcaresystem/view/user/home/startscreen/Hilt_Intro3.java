...
public abstract class Hilt_Intro3 extends BaseActivity implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Intro3_GeneratedInjector) this.generatedComponent()).injectIntro3(UnsafeCasts.<Intro3>unsafeCast(this));
    }
  }
