...
public abstract class Hilt_Intro1 extends BaseActivity implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Intro1_GeneratedInjector) this.generatedComponent()).injectIntro1(UnsafeCasts.<Intro1>unsafeCast(this));
    }
  }
