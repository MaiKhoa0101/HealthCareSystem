...
public abstract class Hilt_SignIn extends BaseActivity implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SignIn_GeneratedInjector) this.generatedComponent()).injectSignIn(UnsafeCasts.<SignIn>unsafeCast(this));
    }
  }
