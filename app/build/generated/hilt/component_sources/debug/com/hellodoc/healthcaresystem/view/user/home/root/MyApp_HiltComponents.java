...
public final class MyApp_HiltComponents {
  ...
  @Subcomponent(
      modules = {
          ...
          FAQItemViewModel_HiltModules.KeyModule.class,
          GeminiViewModel_HiltModules.KeyModule.class,
          HiltWrapper_ActivityRetainedComponentManager_LifecycleModule.class,
          HiltWrapper_ActivitySavedStateHandleModule.class,
          MedicalOptionViewModel_HiltModules.KeyModule.class,
          ...
          SpecialtyViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          FAQItemViewModel_HiltModules.BindsModule.class,
          GeminiViewModel_HiltModules.BindsModule.class,
          HiltWrapper_HiltViewModelFactory_ViewModelModule.class,
          MedicalOptionViewModel_HiltModules.BindsModule.class,
          ...
          SpecialtyViewModel_HiltModules.BindsModule.class,
