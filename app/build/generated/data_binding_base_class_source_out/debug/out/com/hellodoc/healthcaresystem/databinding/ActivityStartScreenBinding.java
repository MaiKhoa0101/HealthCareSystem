...
public final class ActivityStartScreenBinding implements ViewBinding {
  ...
  private ActivityStartScreenBinding(@NonNull LinearLayout rootView, @NonNull Button btnSignIn,
      @NonNull Button btnSignUp, @NonNull ImageButton returnButton,
      @NonNull LinearLayout startscreen) {
  ...
  public static ActivityStartScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout startscreen = (LinearLayout) rootView;

      return new ActivityStartScreenBinding((LinearLayout) rootView, btnSignIn, btnSignUp,
          returnButton, startscreen);
    }
